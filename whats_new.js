...
const WHATS_NEW_ITEMS = [
    ...
    { icon: '★', title: 'การ์ดโปรด & การ์ดที่ดูล่าสุด',
      desc: 'กดดาวในหน้าการ์ดเก็บใบที่สนใจ แล้วกรองดูได้จากปุ่ม ★ / 🕘 ใต้แถบเรียงลำดับ' },
    { icon: '📱', title: 'ดูการ์ดบนมือถือสบายขึ้น',
      desc: 'ปัดซ้าย-ขวาเปลี่ยนการ์ด แตะรูปเพื่อดูใหญ่ และปรับขนาดตัวอักษรความสามารถด้วยปุ่ม A− / A+' },
    { icon: '📝', title: 'โน้ตเด็ค + จัดการคอลเล็คชั่น',
      desc: 'จดแผนการเล่นไว้กับเด็ค ค้นหา/เรียงเด็ค และทำสำเนาเด็คไว้ลองปรับ' },
